...
link = 'https://ru.wikipedia.org/wiki/%D0%A1%D0%B0%D0%BF%D1%91%D1%80_(%D0%B8%D0%B3%D1%80%D0%B0)#:~:text=%D0%A6%D0%B5%D0%BB%D1%8C%D1%8E%20%D0%B8%D0%B3%D1%80%D1%8B%20%D1%8F%D0%B2%D0%BB%D1%8F%D0%B5%D1%82%D1%81%D1%8F%20%D0%BE%D1%82%D0%BA%D1%80%D1%8B%D1%82%D0%B8%D0%B5%20%D0%B2%D1%81%D0%B5%D1%85,%D0%BD%D0%B0%20%D0%BF%D0%B5%D1%80%D0%B2%D0%BE%D0%BC%20%D0%B6%D0%B5%20%D1%85%D0%BE%D0%B4%D1%83%20%D0%BD%D0%B5%D0%B2%D0%BE%D0%B7%D0%BC%D0%BE%D0%B6%D0%BD%D0%BE./'
...
def menu():
    ...
    head = pygame.font.SysFont(font, 50).render("Minesweeper Extend", True, (0, 0, 0))
...
def result(grid, info):
    global flag_medium, flag_hard, flag_esay, start
    ...
    cover.blit(message, message.get_rect(center=[cover.get_width() / 2, cover.get_height() / 2.5]))
...
def main():
    ...
    info = Info(info_size, grid, [grid.surf.get_width(), 0])
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                grid.tile_click(pygame.mouse.get_pos(), event.button)
        ...
        if grid.game_status() is not None:
            result(grid, info)
            square_size = menu()
